...
export default function DocInfo({ docData }) {
  ...
  const docDetails = doc.doctor;
  const docServices = doc.practice;
  ...
  const handleBookAppointment = (type) => {
    ...
    router.push(`/doctors/${docDetails.docSlug}/appointment`);
  }
  ...
  return (
    <Layout 
      title={`${docDetails.seoTitle}`} 
      description={docDetails.metaDiscription}
    >
            ...
            <div className={styles.appointmentContainerForPhone}>
              {docServices.videoFeeAvail && (
                ...
                <ThemeProvider theme={theme}>
                  <Button onClick={() => handleBookAppointment("virtual", docDetails.docSlug)} size="small" variant="contained">
                    Book Appointment
                  </Button>
                </ThemeProvider>
              </div>
              ...
              {docServices.inClinicFeeAvail && (
                ...
                <ThemeProvider theme={theme}>
                  <Button onClick={() => handleBookAppointment("virtual")} size="small" variant="contained">
                    Book Appointment
                  </Button>
                </ThemeProvider>
              </div>
        ...
        <div className={styles.appointmentContainerForPC}>
          {docServices.videoFeeAvail && (
            <div className={styles.appointment}>
              ...
              <ThemeProvider theme={theme}>
                <Link
                  href={`/doctors/${docDetails.docSlug}/appointment`}
                  passHref>
