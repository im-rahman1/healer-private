          ...
          <div className={styles.profileInfoContainer}>
            <div className={styles.profileInfo}>
              ...
              <div className={styles.profileInfo__text}>
                ...
                <Typography variant="caption" sx={{color: '#01a22e'}}>Unani Physician</Typography>
              ...
              <div className={styles.reviewContainer}>
                <div className={styles.badgeContainer}>
                  ...
                  <div className={styles.badgeTxt}>
                    <Typography sx={{whiteSpace: 'noWrap'}} variant="body2">NCT Verified</Typography>
                  </div>
                </div>
                <div className={styles.rating}>
                  <Rating value={3.5} precision={0.5} max={4} sx={{color: '#01a22e'}} size="small" readOnly />
            ...
            <Typography sx={{marginLeft: '0.7rem'}}>Book Appointment</Typography>
          <div className={styles.bookAppointmentContainer}>
            <div className={styles.appointmentCard}>
              <div>
                ...
                <CircleIcon sx={{fontSize: '0.7rem', opacity: 0.8, color: '#01a22e'}} />
            ...
            <div className={styles.appointmentCard}>
              <div className={styles.appointment__info}>
                ...
                <Typography variant='caption'>Main crossing joharTown</Typography>
                <div className={styles.status}>
                <CircleIcon sx={{fontSize: '0.7rem', opacity: 0.8, color: '#01a22e'}} />
                <Typography variant='caption'>Available Today</Typography>
                </div>
